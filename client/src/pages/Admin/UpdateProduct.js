...
const UpdateProduct = () => {
  ...
  const getSingleProduct = async () => {
    try {
      ...
      console.log(error);
      toast.error("Something went wrong in sigle Product");
    }
  };
  useEffect(() => {
    getSingleProduct();
  ...
  const handleUpdateProduct = async (e) => {
    ...
    // }
  if (category) {
      // Check if the category value is an object
  ...
  const handleDeleteProduct = async () => {
    try {
      ...
      console.log(error);
      toast.error("Something went wrong in showing the confirmation modal");
    }
  };
  return (
